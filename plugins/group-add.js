let { generateWAMessageFromContent, prepareWAMessageMedia, proto } = (await import('@adiwajshing/baileys')).default 
 ...
 let captionn = `Hey!! Let me introduce myself, I am "X-Gen-MD" , and I am a Bot for WhatsApp, a person from the group used the command to add you to the group, but I could not add you, so I send you the invitation to add yourself, we are waiting for you!!`     
