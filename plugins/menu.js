...
const listMessage = {
 ...
 /**************************** TIME *********************/
 let wib = moment.tz('Asia/Dhaka').format('HH:mm:ss')
    let wibh = moment.tz('Asia/Dhaka').format('HH')
    let wibm = moment.tz('Asia/Dhaka').format('mm')
    let wibs = moment.tz('Asia/Dhaka').format('ss')
    let wit = moment.tz('Asia/Dhaka').format('HH:mm:ss')
    let wita = moment.tz('Asia/Dhaka').format('HH:mm:ss')
            ...
            templateButtons: [
                {
                    urlButton: {
                        displayText: `${namebot}`,
                        url: 'https://github.com/X-S-L-A-S-H-E-R/X-GEN-MD'
                    }
                },
                {
                    urlButton: {
...
function timeimg() {
  ...
  if (time >= 4) {
    imgloc = ('./media/xgen2.png')
  }
  if (time >= 8) {
    imgloc = ('./media/xgen3.png')
  }
  if (time >= 12) {
    imgloc = ('./media/xgen4.png')
  }
  if (time >= 16) {
    imgloc = ('./media/xgen5.png')
  }
  if (time >= 20) {
    imgloc = ('./media/xgen6.png')
  }
  if (time >= 24) {
    imgloc = ('./media/xgen7.png')
  }
  return imgloc
}
