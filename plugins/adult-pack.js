...
if (!db.data.chats[m.chat].modohorny && m.isGroup) throw '*[❗𝐈𝐍𝐅𝐎❗] ᴛʜᴇ ᴄᴏᴍᴍᴀɴᴅꜱ +18 ᴀʀᴇ ᴅɪꜱᴀʙʟᴇᴅ ɪɴ ᴛʜɪꜱ ɢʀᴏᴜᴘ, ɪꜰ ʏᴏᴜ ᴀʀᴇ ᴀᴅᴍɪɴ ᴀɴᴅ ᴡᴀɴᴛ ᴛᴏ ᴀᴄᴛɪᴠᴀᴛᴇ ᴛʜᴇᴍ ᴜꜱᴇ ᴛʜᴇ ᴄᴏᴍᴍᴀɴᴅ #enable modhorny*'
