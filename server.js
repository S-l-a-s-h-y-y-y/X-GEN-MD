...
function connect(PORT) {
	...
	app.get('/', (req, res) => res.send('Whatsapp Bot By Slasher-Official (X-S-L-A-S-H-E-R)\n\t\t\tVisit this Repo\nhttps://github.com/X-S-L-A-S-H-E-R/X-GEN-MD'))
...
function formatDate(n, locale = 'id') {
	let d = new Date(n)
	return d.toLocaleDateString(locale, { timeZone: 'Asia/Dhaka' })
}
